...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Building2,     label: "Executive",         path: "/kenya/executive" },
      { icon: Landmark,      label: "Parliament",        path: "/kenya/parliament" },
      { icon: Vote,          label: "Senate",            path: "/kenya/senate" },
      { icon: Users,         label: "Governors",         path: "/kenya/governors" },
      { icon: Users,         label: "Women Reps",        path: "/kenya/women-reps" },
  ...
  },
  {
    ...
    accent: "#a78bfa",
    items: [
      { icon: BarChart3,  label: "Premium Analytics",    path: "/premium-analytics" },
