...
export const COUNTRY_CONFIGS: Record<string, CountryConfig> = {
  ...
  ug: {
    ...
    legislature: {
      lowerHouse: "Parliament of Uganda",
      seats: 529,
    },
    rssFeeds: [
      { name: "Monitor Uganda",   url: "https://www.monitor.co.ug/rss.xml",          category: "general",  language: "en" },
      { name: "New Vision",       url: "https://www.newvision.co.ug/rss",             category: "general",  language: "en" },
      { name: "NBS Television",   url: "https://nbstv.ug/feed/",                      category: "general",  language: "en" },
      { name: "ChimpReports",     url: "https://chimpreports.com/feed/",               category: "politics", language: "en" },
    ],
  },
  ...
  cm: {
    ...
    rssFeeds: [
      { name: "Cameroon Tribune",   url: "https://www.cameroon-tribune.cm/feed",      category: "general",  language: "fr" },
      { name: "Journal du Cameroun",url: "https://www.journalducameroun.com/feed/",   category: "general",  language: "fr" },
      { name: "Cameroon Concord",   url: "https://cameroonconcordnews.com/feed/",     category: "politics", language: "en" },
    ],
  },
  ...
  mz: {
    ...
    legislature: {
      lowerHouse: "Assembly of the Republic",
      seats: 250,
    },
    rssFeeds: [
      { name: "Carta de Moçambique", url: "https://cartamz.com/index.php/feed",       category: "general",  language: "pt" },
      { name: "O País",               url: "https://opais.sapo.mz/feed",              category: "general",  language: "pt" },
      { name: "Club of Mozambique",   url: "https://clubofmozambique.com/feed/",       category: "business", language: "en" },
    ],
  },
  ...
  zm: {
    ...
    rssFeeds: [
      { name: "Lusaka Times",    url: "https://www.lusakatimes.com/feed/",             category: "general",  language: "en" },
      { name: "Zambia Daily Mail",url: "https://www.daily-mail.co.zm/feed/",           category: "general",  language: "en" },
      { name: "Zambia Reports",  url: "https://zambiareports.net/feed/",               category: "politics", language: "en" },
      { name: "Business Weekly", url: "https://businessweeklyzambia.com/feed/",        category: "business", language: "en" },
    ],
  },
  ...
  ao: {
    ...
    rssFeeds: [
      { name: "Jornal de Angola",  url: "https://www.jornaldeangola.ao/feed/",         category: "general",  language: "pt" },
      { name: "VOA Portuguese",    url: "https://www.voaportugues.com/api/zmkrpeoq$t", category: "general",  language: "pt" },
      { name: "Angola 24 Horas",   url: "https://angola24horas.com/feed/",             category: "politics", language: "pt" },
    ],
  },
  ...
  sd: {
    ...
    stabilityScore: 12,
    modules: [
      "tracker", "newsfeed", "breaking-news",
      "movements", "alerts", "reports",
    ],
    legislature: {
      lowerHouse: "Transitional Sovereignty Council",
      seats: 0,
    },
    rssFeeds: [
      { name: "Sudan Tribune",    url: "https://sudantribune.com/spip.php?page=backend", category: "general",  language: "en" },
      { name: "Radio Dabanga",    url: "https://www.dabangasudan.org/en/all-news/rss",   category: "general",  language: "en" },
      { name: "Middle East Eye",  url: "https://www.middleeasteye.net/rss",              category: "politics", language: "en" },
    ],
  },
